...
const SortComponent: React.FC<SortProps> = ({
  ...
  return (
    <div className="flex items-center justify-between mt-6">
      ...
      >
        <img className="mr-2" src={order === "asc" ? 'https://ujjnudccckrqqtttlkoo.supabase.co/storage/v1/object/public/spm-assets/down-arrow%201.svg' : 'https://ujjnudccckrqqtttlkoo.supabase.co/storage/v1/object/public/spm-assets/down-arrow%201.svg'}></img>
