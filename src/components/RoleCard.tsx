...
const RoleCard: React.FC<RoleCardProps> = ({
  ...
  var role_deadline_string = formatDate(role_deadline ? role_deadline : null);
  return (
    <div className="w-100 border rounded-lg p-6 shadow-md flex justify-between content-center">
      ...
      <div className="w-64 flex-col justify-between items-center mt-3">
        ...
        <ProgressBar percentage={role_percentage_match} />
      </div>
